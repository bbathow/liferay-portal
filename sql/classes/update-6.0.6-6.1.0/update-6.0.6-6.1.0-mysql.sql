...
alter table DLFileVersion add modifiedDate datetime(6) null;
...
alter table Layout add createDate datetime(6) null;
alter table Layout add modifiedDate datetime(6) null;
...
alter table LayoutSet add createDate datetime(6) null;
alter table LayoutSet add modifiedDate datetime(6) null;
...
alter table LayoutSetPrototype add createDate datetime(6) null;
alter table LayoutSetPrototype add modifiedDate datetime(6) null;
...
alter table PollsVote add createDate datetime(6) null;
alter table PollsVote add modifiedDate datetime(6) null;
