...
insert into Release_ (releaseId, createDate, modifiedDate, servletContextName, schemaVersion, buildNumber, verified) values (1, current_timestamp, current_timestamp, 'portal', '7.0.6', 7006, false);
...
create index IX_60C49142 on PortletPreferences (companyId, ownerId, ownerType, portletId);
