...
alter table BookmarksEntry add treePath longtext null;
alter table BookmarksEntry add status integer;
alter table BookmarksEntry add statusByUserId bigint;
alter table BookmarksEntry add statusByUserName varchar(75) null;
alter table BookmarksEntry add statusDate datetime(6) null;
...
alter table BookmarksFolder add treePath longtext null;
alter table BookmarksFolder add status integer;
alter table BookmarksFolder add statusByUserId bigint;
alter table BookmarksFolder add statusByUserName varchar(75) null;
alter table BookmarksFolder add statusDate datetime(6) null;
...
alter table Contact_ add classNameId bigint;
alter table Contact_ add classPK bigint;
...
alter table DDMStructure add parentStructureId bigint;

drop index IX_490E7A1E on DDMStructure;

alter table DDMTemplate add templateKey varchar(75);
alter table DDMTemplate add cacheable tinyint;
alter table DDMTemplate add smallImage tinyint;
alter table DDMTemplate add smallImageId bigint;
alter table DDMTemplate add smallImageURL longtext;
...
alter table Layout add userId bigint;
...
alter table LayoutPrototype add userId bigint;
alter table LayoutPrototype add userName varchar(75) null;
alter table LayoutPrototype add createDate datetime(6) null;
alter table LayoutPrototype add modifiedDate datetime(6) null;

alter table LayoutSetPrototype add userId bigint;
...
alter table MBCategory add statusByUserId bigint;
alter table MBCategory add statusByUserName varchar(75) null;
alter table MBCategory add statusDate datetime(6) null;

alter table MBDiscussion add uuid_ varchar(75) null;
alter table MBDiscussion add groupId bigint;
alter table MBDiscussion add companyId bigint;
alter table MBDiscussion add userId bigint;
alter table MBDiscussion add userName varchar(75) null;
alter table MBDiscussion add createDate datetime(6) null;
alter table MBDiscussion add modifiedDate datetime(6) null;
...
alter table MBThread add userId bigint;
alter table MBThread add userName varchar(75) null;
alter table MBThread add createDate datetime(6) null;
alter table MBThread add modifiedDate datetime(6) null;

alter table MBThreadFlag add uuid_ varchar(75) null;
alter table MBThreadFlag add groupId bigint;
alter table MBThreadFlag add companyId bigint;
alter table MBThreadFlag add userName varchar(75) null;
alter table MBThreadFlag add createDate datetime(6) null;

alter table Organization_ add uuid_ varchar(75) null;
alter table Organization_ add userId bigint;
alter table Organization_ add userName varchar(75) null;
alter table Organization_ add createDate datetime(6) null;
alter table Organization_ add modifiedDate datetime(6) null;
...
alter table PollsChoice add groupId bigint;
alter table PollsChoice add companyId bigint;
alter table PollsChoice add userId bigint;
alter table PollsChoice add userName varchar(75) null;
alter table PollsChoice add createDate datetime(6) null;
alter table PollsChoice add modifiedDate datetime(6) null;

alter table PollsVote add uuid_ varchar(75) null;
alter table PollsVote add groupId bigint;
...
alter table RepositoryEntry add companyId bigint;
alter table RepositoryEntry add userId bigint;
alter table RepositoryEntry add userName varchar(75) null;
alter table RepositoryEntry add createDate datetime(6) null;
alter table RepositoryEntry add modifiedDate datetime(6) null;
alter table RepositoryEntry add manualCheckInRequired tinyint;
...
alter table Role_ add userId bigint;
alter table Role_ add userName varchar(75) null;
alter table Role_ add createDate datetime(6) null;
alter table Role_ add modifiedDate datetime(6) null;

drop table Roles_Permissions;

alter table SocialActivity add activitySetId bigint;
alter table SocialActivity add parentClassNameId bigint;
alter table SocialActivity add parentClassPK bigint;

alter table SocialActivityCounter add active_ tinyint;
...
alter table UserGroup add userId bigint;
alter table UserGroup add userName varchar(75) null;
alter table UserGroup add createDate datetime(6) null;
alter table UserGroup add modifiedDate datetime(6) null;
...
alter table UserNotificationEvent add delivered tinyint;
