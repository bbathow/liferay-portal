...
alter table BookmarksEntry add treePath text null;
...
alter table BookmarksFolder add treePath text null;
...
alter table DDMTemplate add cacheable bool;
alter table DDMTemplate add smallImage bool;
alter table DDMTemplate add smallImageId bigint;
alter table DDMTemplate add smallImageURL text;
...
alter table RepositoryEntry add manualCheckInRequired bool;
...
alter table SocialActivityCounter add active_ bool;
...
alter table UserNotificationEvent add delivered bool;
