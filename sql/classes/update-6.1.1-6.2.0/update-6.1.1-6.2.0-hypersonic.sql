...
alter table BookmarksEntry add treePath longvarchar null;
...
alter table BookmarksFolder add treePath longvarchar null;
...
alter table DDMTemplate add cacheable bit;
alter table DDMTemplate add smallImage bit;
alter table DDMTemplate add smallImageId bigint;
alter table DDMTemplate add smallImageURL longvarchar;
...
alter table RepositoryEntry add manualCheckInRequired bit;
...
alter table SocialActivityCounter add active_ bit;
...
alter table UserNotificationEvent add delivered bit;
