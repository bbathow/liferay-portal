...
alter table BlogsEntry add statusDate datetime(6);
...
alter table DLFileShortcut add statusDate datetime(6);
...
alter table DLFileVersion add statusDate datetime(6);
...
alter table JournalArticle add statusDate datetime(6);
...
alter table MBMessage add statusDate datetime(6);
...
alter table MBThread add statusDate datetime(6);
...
alter table WikiPage add statusDate datetime(6);
